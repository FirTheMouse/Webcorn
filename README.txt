...
For running webcorn (./webcorn)
    ...
    --tls=[self/domain name] : with tls on, select from the self certification or the proper letsencrypt certification.
...
cmake --build build && ./webcorn --port=443 --private --tls=goldensystems.ca --project=web/electionmadness/ --twigcode=web/electionmadness/website.twg --files=web/electionmadness/files --script=web/electionmadness/init.gld
...
./hazel ./webcorn --port=443 --project=web/electionmadness/ --tls=test.goldensystems.ca --verbosity=3 --units=2

./webcorn --port=8080 --project=web/electionmadness/ --tls=self --verbosity=3 --units=2

ulimit -n 65536 && cmake --build build && ./hazel ./webcorn --port=443 --project=web/goldensystems/ --tls=goldensystems.ca  --track --tickint=5 --units=4
